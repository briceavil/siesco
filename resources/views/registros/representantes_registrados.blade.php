                            ...
                            <div class="max-w mx-auto sm:px-6 lg:px-8">
                                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                    <div class="relative overflow-x-hidden">
                                        <h4 class="text-xl text-center font-bold dark:text-white">REPRESENTANTES REGISTRADOS</h4>
                                        <h5 class="text-lime-500 py-5">N° de representantes: {{$representantes->count()}}</h5>
